                    ...
                    <section class="text-gray-400 bg-gray-900 body-font overflow-hidden">
                            <div class="container px-5 py-24 mx-auto">
                                <div class="lg:w-4/5 mx-auto flex flex-wrap">
                                    <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded imghight" src={data.SmartPhoneImage}     />
                                    <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                                        <h2 class="text-sm title-font text-gray-500 tracking-widest">{data.SmartPhoneName}</h2>
                                        <h1 class="text-white text-3xl title-font font-medium mb-1">I-Phone</h1>
                                        <div>
                                            <h6><span>MoName: </span>{data.SmartPhoneModel}</h6>
                                            <h6><span>PMaker: </span>{data.SmartPhoneMaker}</h6>
                                            <h6><span>MoName: </span>{data.SmartPhoneModel}</h6>
                                            <h6><span>PMaker: </span>{data.SmartPhoneMaker}</h6>
                                            <h7><span>Price: </span>{data.SmartPhonePrice}</h7><br/>    
                                        </div>
                                        ...
                                        <div class="flex ml-6 items-center">
                                            ...
                                            <div class="relative">
                                                <select class="rounded border border-gray-700 focus:ring-2 focus:ring-indigo-900 bg-transparent appearance-none py-2 focus:outline-none focus:border-indigo-500 text-white pl-3 pr-10">
                                                    <option className='optionname'>SM</option>
                                                    <option className='optionname'>M</option>
                                                    <option className='optionname'>L</option>
                                                    <option className='optionname'>XL</option>
                                                </select>
